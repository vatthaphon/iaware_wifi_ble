...
static esp_ble_adv_params_t adv_params = {
    ...
    // .adv_int_min        = 0x1F40, // [uint16_t], 0xffff, Minimum advertising interval for undirected and low duty cycle directed advertising. Range: 0x0020 to 0x4000 Default: N = 0x0800 (1.28 second) Time = N * 0.625 msec Time Range: 20 ms to 10.24 sec 
    // .adv_int_max        = 0x1F41, // [uint16_t], 0xffff, Maximum advertising interval for undirected and low duty cycle directed advertising. Range: 0x0020 to 0x4000 Default: N = 0x0800 (1.28 second) Time = N * 0.625 msec Time Range: 20 ms to 10.24 sec Advertising max interval 
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) 
{
    switch (event) 
    {
        case ESP_GATTS_REG_EVT: // When register application id, the event comes.
            ...
            str_to_uuid128(&(gl_profile_tab[PROFILE_A_APP_ID]), IAWARE_BLE_SERVICE_UUID);
        ...
        case ESP_GATTS_WRITE_EVT:
            ...
            if (!param->write.is_prep)
            {
                ESP_LOGI(IAWARE_BLE, "A: ESP_GATTS_WRITE_EVT, value len %d, value :", param->write.len);
        ...
        case ESP_GATTS_CREATE_EVT: // When create service complete, the event comes.
            ...
            // We are or-ing the selected properties.
            ...
            a_permission = ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE;
        ...
        case ESP_GATTS_ADD_CHAR_EVT: // When add characteristic complete, the event comes.
            ESP_LOGI(IAWARE_BLE, "A: ESP_GATTS_ADD_CHAR_EVT");            
            ...
            // This function is called to add characteristic descriptor.
